...
module top;
  ...
  always_comb begin
    ...
    else if (a == 4) $display("4"); // values 3, 5, 6, 7 cause
                                    // a violation report
  end
  ...
  initial begin
    ...
    // directive type is assert but it has selected cover directive 'c1'.
    #10 $assertcontrol(ON, CONCURRENT | S_IMMEDIATE | D_IMMEDIATE, ASSERT,
                       0, c1);
