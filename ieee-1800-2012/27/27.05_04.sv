...
module sms_08b216t0(clk, csb, cke, ba, addr, rasb,
                    casb, web, udqm, ldqm, dqi, dev_id);

  input clk, csb, cke, ba, rasb, casb, web, ldqm, udqm;
  inout [15:0] dqi;
  input [10:0] addr;
  input [4:0] dev_id;
...
module top(addr, ba, rasx, casx, csx, wex, cke, clk, dqm, data, dev_id);
